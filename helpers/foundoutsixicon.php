 ...
 * 
 * Adapted for Foundation 5 & 6 to avoid Bootstrap Tooltips
 * 
 */
 ...
 * @since  1.5
 */
abstract class JHtmlFoundoutSixIcon
{
	/**
	 ...
	 * @param   Registry  $params   The item parameters
	 * @param   array     $attribs  Optional attributes for the link
	 * @param   boolean   $legacy   True to use legacy images, false to use template based graphic
	 *
	...
	public static function email($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			if ($legacy)
			{
				$text = JHtml::_('image', 'system/emailButton.png', null, true);
			}
			else
			{
