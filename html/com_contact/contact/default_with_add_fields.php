    ...
    <div class="mygrey">
        <div class="medium-12 columns">
            ...
            <?php if ($this->params->get('contact_vatnumber', false)) : ?>
                <div>
                    <span class="contact-vat"><?php echo $this->params->get('contact_vatnumber'); ?><br/>
                        <?php echo $this->params->get('contact_rpr'); ?><br/>
                        <?php echo $this->params->get('contact_bankaccount'); ?><br/>
                    </span>
                </div>
                <!--insert additional parameters -->
            <?php endif; ?>
