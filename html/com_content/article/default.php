		...
		<?php if ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon')) : ?>
			<ul class="actions">
				<?php if ($params->get('show_print_icon')) : ?>
					<li class="print"><?php echo JHtml::_('foundoutsixicon.print_popup',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($params->get('show_email_icon')) : ?>
					<li class="email"> <?php echo JHtml::_('foundoutsixicon.email',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<li class="edit"> <?php echo JHtml::_('foundoutsixicon.edit', $this->item, $params); ?> </li>
				<?php endif; ?>
			</ul>
		<?php endif; ?>
	<?php endif; ?>
