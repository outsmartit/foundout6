...
<article>
	<?php if ($params->get('show_print_icon') || $params->get('show_email_icon') || $canEdit) : ?>
			<ul class="actions">
				<?php if ($params->get('show_print_icon')) : ?>
					<li class="print-icon"> <?php echo JHtml::_('foundoutsixicon.print_popup',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($params->get('show_email_icon')) : ?>
					<li class="email-icon"> <?php echo JHtml::_('foundoutsixicon.email',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<li class="edit-icon"> <?php echo JHtml::_('foundoutsixicon.edit', $this->item, $params); ?> </li>
				<?php endif; ?>
			</ul>
	<?php endif; ?>
	...
	<?php if ($useDefList AND ($info == 0 OR $info == 2)) : ?>
		<section class="article-info">
			<ul class="foundout-article-info inline">
		...
		<?php if ($params->get('show_publish_date')) : ?>
			<li class="published"><i class="fa fa-calendar"></i>
		...
		<?php if ($info == 0): ?>
			<?php if ($params->get('show_modify_date')) : ?>
					...
					<?php if ($params->get('show_hits')) : ?>
							<li class="hits"><i class="fa fa-eye"></i>
