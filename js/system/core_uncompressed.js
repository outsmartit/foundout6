...
(function( Joomla, document ) {
	...
	Joomla.renderMessages = function( messages ) {
		...
		for ( type in messages ) {
			...
			alertClass = (type == 'notice') ? ' primary' :  type;
			alertClass = (type == 'message') ? ' success' : alertClass;

			messagesBox.className = 'callout ' + alertClass;
                        messagesBox.setAttribute('data-closable');
			// Close button
			buttonWrapper = document.createElement( 'button' );
			buttonWrapper.setAttribute('type', 'button');
			buttonWrapper.setAttribute('data-close', '');
			
			buttonWrapper.innerHTML = '<span aria-hidden="true">&times;</span>';
